...
function getNowMilitary(){
    ...
    return moment().add(8,'hours').format('MMDD_HHmm');
}
...
// var urlBus01="http://data.taipei/bus/PathDetail";
// var urlBus02="http://data.taipei/bus/CarInfo";
var urlBik01="http://data.taipei/youbike";



var j = schedule.scheduleJob('* * * * *', function(){
    var filename1="bus_downloads/PathDetail_"+getNowMilitary()+".gz";
    var filename2="bus_downloads/CarInfo_"+getNowMilitary()+".gz";
    var filename3="bik_downloads/YouBikeTP_"+getNowMilitary()+".gz";
    // var file = fs.createWriteStream(filename);
    // var request = http.get(urlBus01, function(response) {
    //     response.pipe(file);
